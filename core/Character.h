...
namespace ginkgo
{
	...
	public:
		...
		quat getRotationQ() const override { return quat(rotation); }
		vec3 const& getRotation() const override { return rotation; }
		...
		void setRotation(const vec3& rot) override { rotation = rot; }
		void setRotationQ(const quat& rot) override { rotation = glm::eulerAngles(rot); }
